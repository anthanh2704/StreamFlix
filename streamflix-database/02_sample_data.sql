...
INSERT INTO subscription_plan
    (plan_name, price, max_quality, max_devices, description)
VALUES
...
INSERT INTO app_user
    (username, email, password_hash, full_name, date_of_birth, country, role)
VALUES
    ('alice', 'alice@mail.com', '$2a$10$hash1', 'Alice Nguyen', '1998-03-12', 'Vietnam', 'CREATOR'),
    ('bob', 'bob@mail.com', '$2a$10$hash2', 'Bob Tran', '1995-07-22', 'Vietnam', 'CREATOR'),
    ('charlie', 'charlie@mail.com', '$2a$10$hash3', 'Charlie Pham', '2000-11-05', 'USA', 'CREATOR'),
    ('david', 'david@mail.com', '$2a$10$hash4', 'David Le', '2001-05-30', 'Vietnam', 'USER'),
    ('eve', 'eve@mail.com', '$2a$10$hash5', 'Eve Hoang', '1999-09-14', 'Singapore', 'USER'),
    ('frank', 'frank@mail.com', '$2a$10$hash6', 'Frank Vo', '2002-02-18', 'Vietnam', 'USER'),
    ('grace', 'grace@mail.com', '$2a$10$hash7', 'Grace Do', '1997-12-01', 'USA', 'USER'),
    ('henry', 'henry@mail.com', '$2a$10$hash8', 'Henry Bui', '1996-04-25', 'Vietnam', 'USER'),
    ('ivy', 'ivy@mail.com', '$2a$10$hash9', 'Ivy Lam', '2003-08-08', 'Japan', 'USER'),
    ('admin', 'admin@mail.com', '$2a$10$hashA', 'System Admin', '1990-01-01', 'Vietnam', 'ADMIN');

-- 3. User subscriptions (platform plans)
INSERT INTO user_subscription
    (user_id, plan_id, start_date, end_date, status)
VALUES
    (1, 4, '2026-01-01', '2026-12-31', 'ACTIVE'),
    -- alice, Premium
    (2, 3, '2026-02-01', '2026-12-31', 'ACTIVE'),
    -- bob,   Standard
    (3, 4, '2025-06-15', '2026-06-15', 'ACTIVE'),
    -- charlie, Premium
    (4, 2, '2026-03-01', '2026-09-01', 'ACTIVE'),
    -- david, Basic
    (5, 5, '2026-01-15', '2027-01-15', 'ACTIVE'),
    -- eve, Family
    (6, 1, '2026-01-01', '2027-01-01', 'ACTIVE'),
    -- frank, Free
    (7, 3, '2025-12-01', '2026-06-01', 'EXPIRED'),
    -- grace, expired Standard
    (8, 2, '2026-04-01', '2026-10-01', 'ACTIVE'),
    -- henry, Basic
    (9, 1, '2026-02-01', '2027-02-01', 'ACTIVE');
-- ivy, Free

-- 4. Payments
INSERT INTO payment
    (subscription_id, amount, method, status, transaction_ref)
VALUES
...
INSERT INTO channel
    (owner_user_id, channel_name, description, subscriber_count)
VALUES
...
-- 8. Videos
INSERT INTO video
    (channel_id, title, description, video_url, thumbnail_url, duration_sec, resolution, status, is_premium, upload_date)
VALUES
    -- Alice Cooks
...
-- 13. Comments
INSERT INTO comment
    (video_id, user_id, parent_comment_id, content)
VALUES
...
INSERT INTO watch_history
    (user_id, video_id, watch_duration, progress_pct, device_type, watched_at)
VALUES
...
INSERT INTO notification
    (user_id, type, content, link_url, is_read)
VALUES
